...
[Documentation index](../README.md) · [SDK overview](../../README.md) · [Generated source](../../src/api/suppressions.rs)
...
| [`export_suppressions`](#export-suppressions) | `GET` | `/v1/projects/{projectId}/suppressions/export` | `()` | — |
| [`add_suppression`](#add-suppression) | `POST` | `/v1/projects/{projectId}/suppressions` | `SuppressionResponse` | — |
| [`remove_suppression`](#remove-suppression) | `DELETE` | `/v1/projects/{projectId}/suppressions/{email}` | `()` | — |
