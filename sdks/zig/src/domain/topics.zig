...
/// Operations for the topics domain.
pub const TopicsApi = struct {
    transport: *transport.Transport,

    /// GET /v1/projects/${projectId}/topics
    pub fn listTopics(self: *@This(), projectId: []const u8,
        options: transport.RequestOptions) !transport.Result(std.json.Parsed(types.TopicPageResponse)) {
    ...
    pub fn getTopic(self: *@This(), projectId: []const u8,
        topicId: []const u8,
        options: transport.RequestOptions) !transport.Result(std.json.Parsed(types.TopicResponse)) {
        const allocator = self.transport.allocator;
        ...
        path_values[path_count] = .{ .name = "projectId", .value = path_allocations[path_count] };
        path_count += 1;
        path_allocations[path_count] = try transport.Transport.formatValue(allocator, topicId);
        path_values[path_count] = .{ .name = "topicId", .value = path_allocations[path_count] };
        path_count += 1;
    ...
    pub fn listContactsInTopic(self: *@This(), projectId: []const u8,
        topicId: []const u8,
    ...
    pub fn createTopic(self: *@This(), projectId: []const u8,
        input: types.CreateTopicBody,
        options: transport.RequestOptions) !transport.Result(std.json.Parsed(types.TopicResponse)) {
        const allocator = self.transport.allocator;
    ...
    pub fn updateTopic(self: *@This(), projectId: []const u8,
        topicId: []const u8,
        input: types.UpdateTopicBody,
        options: transport.RequestOptions) !transport.Result(std.json.Parsed(types.TopicResponse)) {
        const allocator = self.transport.allocator;
    ...
    pub fn deleteTopic(self: *@This(), projectId: []const u8,
        topicId: []const u8,
