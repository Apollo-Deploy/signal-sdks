...
[Documentation index](../README.md) · [SDK overview](../../README.md) · [Generated source](../../src/main/kotlin/com/apollodeploy/signal/sdk/api/ContactsAPI.kt)
...
| [`deleteContact`](#deletecontact) | `DELETE` | `/v1/projects/{projectId}/contacts/{contactId}` | `Unit` | — |
...
| [`deleteContactImage`](#deletecontactimage) | `DELETE` | `/v1/projects/{projectId}/contacts/{contactId}/image` | `Unit` | — |
| [`addContactToSegment`](#addcontacttosegment) | `POST` | `/v1/projects/{projectId}/contacts/{contactId}/segments` | `Unit` | — |
| [`removeContactFromSegment`](#removecontactfromsegment) | `DELETE` | `/v1/projects/{projectId}/contacts/{contactId}/segments/{segmentId}` | `Unit` | — |
| [`updateContactTopics`](#updatecontacttopics) | `PATCH` | `/v1/projects/{projectId}/contacts/{contactId}/topics` | `Unit` | — |
...
| [`recordContactEmailValidation`](#recordcontactemailvalidation) | `POST` | `/v1/projects/{projectId}/contacts/{contactId}/email-validation` | `Unit` | — |
