defmodule ApolloSignal.Transport do
  ...
  @spec new(keyword()) :: t()
  def new(opts \\ []) do
    base_url = opts |> Keyword.get(:base_url, "https://api.signal.apollodeploy.com") |> normalize_base_url()
    ...
    user_agent = Keyword.get(opts, :user_agent, "apollo_signal-elixir-sdk/4.0.1")
