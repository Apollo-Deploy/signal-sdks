...
[Documentation index](../README.md) · [SDK overview](../../README.md) · [Generated source](../../src/api/contacts.rs)
...
| [`delete_contact`](#delete-contact) | `DELETE` | `/v1/projects/{projectId}/contacts/{contactId}` | `()` | — |
...
| [`delete_contact_image`](#delete-contact-image) | `DELETE` | `/v1/projects/{projectId}/contacts/{contactId}/image` | `()` | — |
| [`add_contact_to_segment`](#add-contact-to-segment) | `POST` | `/v1/projects/{projectId}/contacts/{contactId}/segments` | `()` | — |
| [`remove_contact_from_segment`](#remove-contact-from-segment) | `DELETE` | `/v1/projects/{projectId}/contacts/{contactId}/segments/{segmentId}` | `()` | — |
| [`update_contact_topics`](#update-contact-topics) | `PATCH` | `/v1/projects/{projectId}/contacts/{contactId}/topics` | `()` | — |
...
| [`record_contact_email_validation`](#record-contact-email-validation) | `POST` | `/v1/projects/{projectId}/contacts/{contactId}/email-validation` | `()` | — |
