...
[Documentation index](../README.md) · [SDK overview](../../README.md) · [Generated source](../../src/main/kotlin/com/apollodeploy/signal/sdk/api/SuppressionsAPI.kt)
...
| [`exportSuppressions`](#exportsuppressions) | `GET` | `/v1/projects/{projectId}/suppressions/export` | `Unit` | — |
| [`addSuppression`](#addsuppression) | `POST` | `/v1/projects/{projectId}/suppressions` | `SuppressionResponse` | — |
| [`removeSuppression`](#removesuppression) | `DELETE` | `/v1/projects/{projectId}/suppressions/{email}` | `Unit` | — |
