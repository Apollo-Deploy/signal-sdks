...
[Documentation index](../README.md) · [SDK overview](../../README.md) · [Generated source](../../apollo_deploy_signal_sdk/resources/webhooks.py)
...
| [`delete_webhook`](#delete-webhook) | `DELETE` | `/v1/projects/{projectId}/webhooks/{endpointId}` | `None` | — |
| [`test_webhook`](#test-webhook) | `POST` | `/v1/projects/{projectId}/webhooks/{endpointId}/test` | `WebhookDeliveryResponse` | — |
| [`replay_webhook_delivery`](#replay-webhook-delivery) | `POST` | `/v1/projects/{projectId}/webhooks/{endpointId}/replay/{deliveryId}` | `None` | — |
