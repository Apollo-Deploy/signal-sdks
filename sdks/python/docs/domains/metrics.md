...
[Documentation index](../README.md) · [SDK overview](../../README.md) · [Generated source](../../apollo_deploy_signal_sdk/resources/metrics.py)
...
|---|---|---|:---:|---|
| `id` | Path | `str` | Yes | — |
| `window` | Query | `str` | No | Time window. |
| `projectId` | Query | `str` | No | Required for session auth; ignored for API key auth. |
...
| Name | Location | Type | Required | Description |
|---|---|---|:---:|---|
| `window` | Query | `str` | No | Metrics time window. |
| `projectId` | Query | `str` | No | Required for session auth; ignored for API key auth. |
...
|---|---|---|:---:|---|
| `window` | Query | `str` | No | Metrics time window. |
| `granularity` | Query | `str` | No | `hour` or `day`. |
| `format` | Query | `str` | No | `compact` or `detailed`. |
| `projectId` | Query | `str` | No | Required for session auth; ignored for API key auth. |
